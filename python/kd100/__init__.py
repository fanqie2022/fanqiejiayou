...
class KuaiDi100:
    def __init__(self):
        ...
        快递公司编号 = input()
        self.customer = 快递公司编号  # TODO 查询公司编号
    ...
    def map_track(self, com, num, phone, ship_from, ship_to, orderTime):
        ...
        :param orderTime: 订单下单时间，格式为（yyyy-MM-dd HH:mm:ss）如：2021-12-16 12:59:59
...
result = KuaiDi100().map_track('yuantong', 'YT969****639795', '', '广东省江门市', '广东省深圳市', '2021-08-01 20:04:44')
print(result)